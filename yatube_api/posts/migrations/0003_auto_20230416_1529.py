# Generated by Django 3.2.16 on 2023-04-16 12:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='follow',
            name='following',
            field=models.ForeignKey(help_text='Автор поста', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='following', to=settings.AUTH_USER_MODEL, verbose_name='Укажите на кого подписываемся'),
        ),
        migrations.AddField(
            model_name='post',
            name='group',
